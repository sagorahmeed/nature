         ...
         <Helmet>
            ...
            <div>
                ...
                <div className="bg-[#fbf4d1] pt-[80px]">
                    ...
                    <div id="section2" className="kit-container w-full xl:h-[729px]  lg:h-[729px] sm:h-[548px] h-[410px] relative flex items-end justify-center translate-y-[150px]" data-aos="fade-up"
                    >
                    ...
                    <div id="section3" className="kit-container w-full xl:h-[729px]  lg:h-[729px] sm:h-[548px] h-[410px] relative flex items-end justify-center translate-y-[150px]" data-aos="fade-up"
                    >
                    ...
                    <div id="section4" className="kit-container w-full xl:h-[729px]  lg:h-[729px] sm:h-[548px] h-[410px] relative flex items-end justify-center translate-y-[150px]" data-aos="fade-up"
                    >
