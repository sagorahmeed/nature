                            ...
                            <div className='kit-container'>
                                <div className='flex justify-center'>
                                    <ul className='flex justify-center items-center gap-[14px]'>
                                        <li className={`${activeTab === 'dryFood' ? 'active bg-white text-[#81312d] shadow-[0_3px_2px_#b9b9b9]' : ''} bg-[#f89e03] px-[20px] shadow-[0_3px_2px_#df9412] text-white text-[24px] leading-[42px] py-[15px] rounded-full cursor-pointer transition-all duration-200`} onClick={() => handleTabChange('dryFood')}>Adult Dog Nutrition</li>
                                        <li className={`${activeTab === 'stapleFood' ? 'active bg-white text-[#81312d] shadow-[0_3px_2px_#b9b9b9]' : ''} bg-[#f89e03] px-[20px] shadow-[0_3px_2px_#df9412] text-white text-[24px] leading-[42px] py-[15px] rounded-full cursor-pointer transition-all duration-200`} onClick={() => handleTabChange('stapleFood')}>Antarctic Krill Meat</li>
                                        <li className={`${activeTab === 'snaksFood' ? 'active bg-white text-[#81312d] shadow-[0_3px_2px_#b9b9b9]' : ''} bg-[#f89e03] px-[20px] shadow-[0_3px_2px_#df9412] text-white text-[24px] leading-[42px] py-[15px] rounded-full cursor-pointer transition-all duration-200`} onClick={() => handleTabChange('snaksFood')}>Delicious Vegetable Pieces</li>
                                    </ul>
                                </div>
