...
function Home() {
    ...
    return (
        <>
            <div>
                <div style={bannerBg1}>
                    <div className='visible-home pt-[160px]'>
                        <img src="/image/157602742554234eyeu (1).png" alt="" />
                    </div>
                </div>
                <div className="py-[100px] relative " style={bannerBg2}>
                    ...
                    <div className="max-w-[1440px] mx-auto md:px-0 px-[20px]">
                        <div>
                            <img className="absolute left-0 top-0 mt-[-90px] w-[315px] h-[236px]" src="/image/goulang.png" alt="img" />
                        </div>
                        ...
                        <div className="md:grid grid-cols-12 items-center gap-[30px] mt-[60px] relative">
                            <div className="col-span-6 relative">
                                <img src="./image/long-cat.png" className="w-full" alt="cat" />
                            </div>
                            <div className="col-span-6 md:pt-0 pt-[50px]">
                                ...
                                <img src="/image/cat.png" className="absolute right-0 bottom-0" alt="cat" />
                            </div>
                        </div>
                        ...
                        <div className="max-w-[889px] max-h-[564px] w-full h-full pt-[95px] mx-auto flex justify-center items-center">
                            <img className="max-w-[889px] h-[464px] w-full h-full mx-auto static z-[2]" src="image/vidoe-banner.png" alt="video" />
                            <img className="absolute cursor-pointer z-[3]" src="image/play-btn.png" alt="video" />
                            <img className="absolute right-0 bottom-0 z-[1]" src="image/image-spape-2.png" alt="video" />
                        </div>
                    </div>
                    <img className="" src="image/rou.png" alt="video" />
                    <div className="text-center">
                        ...
                        <div className="max-w-[1440px] mx-auto md:px-0 px-[20px]">
                            <div className="md:grid grid-cols-12 items-center gap-[30px] mt-[60px] relative">
                                ...
                                <div className="col-span-5 md:pt-0 pt-[50px]">
                                    ...
                                    <ul className="space-y-[17px] mt-[40px] grid grid-cols-12 gap-4">
                            ...
                            <div className="grid grid-cols-12 pt-[47px] gap-[33px]">
