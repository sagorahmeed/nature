        ...
        <div className='relative'>
            ...
            <div className={`kit-container mx-auto md:px-0 px-[20px]  `}>
                <footer className={`pb-[20px] px-[20px] sm:pt-[80px] pt-[40px]`}>
                    <div className="sm:grid grid-cols-10 gap-[60px] sm:space-y-0 space-y-[32px]">
                        ...
                        <div className="xl:col-span-8 col-span-6 ">
                            <div className="lg:grid grid-cols-10 gap-[16px] xs:pb-0 pb-[30px] lg:space-y-0 xs:space-y-[44px] space-y-[24px]">
                                <div className="col-span-3 xs:pb-[40px] pb-[10px]">
                                    <h2 className="text-[20px] text-[#5d261b] font-medium leading-[20px] capitalize">Brand story</h2>
                                    <ul className="space-y-[10px] sm:pt-[25px] pt-[16px]">
                                ...
                                <div className="col-span-4 xs:pb-[40px] pb-[10px]">
